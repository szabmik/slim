...
class AppSettings extends ArraySettings
{
     ...
     */
    public function __construct(private string $name, private string $env, private bool $displayErrorDetails, private bool $logErrors, private bool $logErrorDetails)
    {
