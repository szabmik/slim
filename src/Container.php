...
class Container
{
     ...
     * @param string|null $compilationDir Directory for compiled container cache.
     *        Required when $enableCompilation is true, throws otherwise.
     *
        ...
        if ($enableCompilation) {
            if ($compilationDir === null) {
                throw new \InvalidArgumentException(
                    'A compilationDir must be provided when enableCompilation is true.'
                );
            }
            $containerBuilder->enableCompilation($compilationDir);
        }
     ...
     *
     * @param ContainerBuilder<\DI\Container> $builder The container builder to configure.
